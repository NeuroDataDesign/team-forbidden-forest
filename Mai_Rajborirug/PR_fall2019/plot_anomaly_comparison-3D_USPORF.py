...
This example is an extension of anomaly detection comparison from `sckit-learn 2.7.1`. These experiment applied sixalgorithm on 3D toy dataset. The six algorithms are :class:`sklearn.covariance.EllipticEnvelope`, :class:`sklearn.svm.OneClassSVM`, :class:`sklearn.ensemble.IsolationForest`, :class:`sklearn.neighbors.LocalOutlierFactor`, `Extended Isolation Forest`. on 3D toy data simulation. The classification performance is compared by AUC score :class:`sklearn.metrics.roc_auc_score`.
